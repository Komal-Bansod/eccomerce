...
import { ERROR,INVENTORY,Users , ITokenData, PLAYLISTS } from '../../common/global-constants';
...
export const createHandler = async (req: Request, res: Response) => {
  try {
   ...
   let createPlaylists
    ...
    createPlaylists = await Playlists.create({
    ...
    return res
      ...
      .send(responseGenerators(removeFields(createPlaylists), StatusCodes.OK, PLAYLISTS.CREATED, false));
